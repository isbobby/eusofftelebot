...
bot_replies = {
    'welcome':
        ...
        u'\nUse /CalendarBot to view this month\'s calendar of events 📅'
        u'\nUse /HamsumBoy to see Hamsumboy!!! 😍',
        #u'\nUse /FAQBot to view FAQ '
        #u'\nUse /LaundryBot to view laundry machines' status 🧺'
